...
export default function More() {
    return (
        <Popover className="relative">
            <Popover.Button className="py-[1px] block group outline-none">
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden">
                ...
                <button className="h-14 px-4 w-full transition-colors inline-flex items-center gap-5 hover:bg-[#eff3f41a]">
                    <div className="w-[26.25px] h-[26.25px] relative">
                        <svg viewBox="0 0 24 24" width={26.25} height={26.25} className="block">
                            <path
                                fill="#e7e9ea"
                ...
                <div className="h-px bg-[#2f3336] my-0.5 mx-auto w-[89%]" />
                ...
                <Disclosure>
                    ...
                    {({ open }) => (
                        ...
                        <>
                            <Disclosure.Button className="h-[52px] px-4 flex items-center justify-between w-full font-bold hover:bg-[#eff3f41a] transition-colors">
                                Creator Studio
